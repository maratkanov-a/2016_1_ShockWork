(function () {
  ...
  var assetLoader = (function() {
    ...
    this.img        = {
      ...
      'water'         : 'img/water.png',
      'grass1'        : 'img/grassMid1.png',
      'grass2'        : 'img/grassMid2.png',
      'bridge'        : 'img/bridge.png',
      'plant'         : 'img/plant.png',
      'bush1'         : 'img/bush1.png',
      'bush2'         : 'img/bush2.png',
      'cliff'         : 'img/grassCliffRight.png',
     ...
     * @param {number} dic  - Dictionary name ('img', 'sounds', 'fonts')
  ...
  var player = (function(player) {
    ...
    player.walkAnim  = new Animation(player.sheet, 1, 0, 8);
    player.jumpAnim  = new Animation(player.sheet, 1, 0, 8);
    player.fallAnim  = new Animation(player.sheet, 1, 0, 8);
  ...
  function Sprite(x, y, type) {
    ...
    this.draw = function() {
      ...
      ctx.drawImage(assetLoader.img[this.type], this.x, this.y);
      ctx.restore();
    };
  }
